...
- **[Skill Self-Improving](./skill-self-improving)**
  - A meta-skill invoked via `/self-improve` at the end of coding sessions. Analyses all session work and systematically audits, updates, creates, or removes skills to capture learnings and keep the skill library current.
  - *Key Concepts*: Session Analysis, Skill Gap Detection, Skill Audit, Change Reporting, Continuous Improvement.
